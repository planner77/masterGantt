...
프로젝트별 직접 링크, SQLite 저장과 편집 비밀번호 인증을 구현했으며, Task/Gantt 저장, 승인된 Excel/VBA → JSON·CSV Import, Excel Export, 단일 Docker 애플리케이션 배포를 단계적으로 진행한다. DRM 해제·우회 기능은 개발하지 않는다.
