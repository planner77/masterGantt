...
#130 Phase 1 [PR #150](https://github.com/planner77/masterGantt/pull/150)의 head `e4e7a7fdc4340dec8366bd51ff1d3001c99cf845`는 선행 #121 branch와 Phase 1 고유 10파일을 통합했다. [CI run 36008880109](https://github.com/planner77/masterGantt/actions/runs/36008880109)에서 quality/docker는 PASS, e2e는 14:05 UTC 기준 진행 중으로 최종 판정 NOT TESTED다. [별도 Docker 미리보기](http://localhost:8309)는 exact head/tree label, version `0.27.7`, healthy/readiness 200을 확인했으며 기존 컨테이너·volume을 보존했다. 구현 전후 화면 실측은 NOT TESTED다. 후속 PR #152–#154는 open/head 불변이고 새 수정이 자동 상속되지 않았으며, 기존 CI 외 새 run이 없다. 병합·Issue 종료는 진행하지 않았다.
