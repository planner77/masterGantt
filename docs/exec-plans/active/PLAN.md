...
2026-09-24 13:35 UTC 기준 #140 [PR #161](https://github.com/planner77/masterGantt/pull/161)은 F2 테스트의 Grid 선택 행·PATCH 대상 확인을 보완한 head `22435cc115571b1f9494f8b93a5a90e88942c2b3`으로 갱신했고 [CI run 36006366745](https://github.com/planner77/masterGantt/actions/runs/36006366745)가 시작됐다. #142 [PR #162](https://github.com/planner77/masterGantt/pull/162)는 이 수정을 상속한 head `51f7aa0108f62ff19832578b1f6afa6ec635e195`에서 [CI run 36006864375](https://github.com/planner77/masterGantt/actions/runs/36006864375)가 시작됐다. 두 새 head의 quality/e2e/docker 최종 결과는 확인 전으로 NOT TESTED이고, 독립 정적 QA만 PASS다. 순수 Tab→F2 경로는 미검증이며 #142 Milestone 중앙 정렬 AC는 여전히 미충족이다. 아래 이전 head의 CI와 로컬 Docker 증거는 당시 기록이다.
...
문서 [PR #165](https://github.com/planner77/masterGantt/pull/165)의 최신 확인 head `e069e9a7d2ad53e4265cb4fc081e3c7f442f61a7` [CI run 36002644818](https://github.com/planner77/masterGantt/actions/runs/36002644818)은 quality/e2e/docker PASS, E2E 100건 PASS이며 독립 QA도 문서 2파일 범위에서 PASS다. 이 문서에 새 #140·#142 head 상태를 추가했으므로 해당 PASS를 새 문서 변경의 검증으로 전용하지 않는다. 이전 head `96a7e7f16d0da797924cf2d657957bfac5344a7d` [CI run 35999350839](https://github.com/planner77/masterGantt/actions/runs/35999350839)의 quality/docker PASS·e2e 99 PASS/1 FAIL은 편집 권한 E2E API GET `ECONNRESET`이었다. 원인은 미확정이며 당시 실패 증거로 보존한다.
