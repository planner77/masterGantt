...
현재 #140 [PR #161](https://github.com/planner77/masterGantt/pull/161)의 head `c09f90f6943530c608fa42d24e92a2eefc23ee89`에서 [CI run 35997955291](https://github.com/planner77/masterGantt/actions/runs/35997955291), 이를 선행으로 보존한 #142 [PR #162](https://github.com/planner77/masterGantt/pull/162)의 head `8d9f44e9c5a070d3a68e6eec5f49007d56f20896`에서 [CI run 35998150981](https://github.com/planner77/masterGantt/actions/runs/35998150981) 시작을 확인했다. 12:23 UTC 두 최신 run 모두 quality/docker PASS·e2e 진행 중으로 전체 결과는 미판정이다. 직전 #140 head `5cdbe08…`의 e2e는 102 PASS/18 FAIL(#140 전용 2 PASS/1 FAIL), #142 head `9bf7e3e…`의 e2e는 103 PASS/18 FAIL/1 skipped였다. Trace에 따라 #140 Chart scrollLeft가 바뀌어도 content 좌표를 비교하고, #142 좁은 화면에서 실제 보이는 날짜 셀을 스크롤 후 다시 확인하도록 E2E를 수리했다. #142 Milestone 중앙 정렬은 미충족이며 Issue는 열려 있다.

2026-09-24 12:24 UTC 조회 시 원격 main은 외부 #119 제품·문서 병합 및 lifecycle helper 추가로 `88eb67413c7b1d4b7a96cca3db98984810ed7839` / version `0.27.5`가 됐다. [main CI 35997721645](https://github.com/planner77/masterGantt/actions/runs/35997721645)는 quality/docker PASS·e2e 진행 중이며 #119 Issue는 open이다. 앞선 main `5699e051…`의 [CI 35994252173](https://github.com/planner77/masterGantt/actions/runs/35994252173)는 quality/e2e/docker와 임시 image 게시·검증·정리 job이 PASS였으나 현재 main의 결과로 전용하지 않는다. #116·#117·#118은 다른 작업에서 종료됐다. 이 작업에서는 병합·Issue 종료를 실행하지 않았다. #142 최신 head의 별도 Docker 미리보기(8308)는 healthy/readiness 200이며 기존 미리보기와 volume은 보존했다. 아래 과거 main·Issue 상태는 당시 기록으로 읽고 최신 상태는 [UI/UX 실행 계획](UI_UX_ROLLOUT.md)을 따른다.
