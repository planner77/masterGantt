...
| R44 | Project 목록은 Desktop/Wide에서 일반 Form보다 넓은 가용 폭을 사용하고, 프로젝트명 Link를 primary navigation으로 유지하며 행 command를 accessible overflow menu로 제공한다 (#75). | native table semantics, Link/Button 의미, keyboard/Escape/focus 복귀, 390/768/1024/1440 반응형, 기존 copy/delete 보안 계약 유지. [UX 계약](PROJECT_UX.md) |
