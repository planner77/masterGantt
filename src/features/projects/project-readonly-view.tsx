...
import { ProjectCopyButton } from "@/features/projects/project-copy-button";
  ...
  return <section className="project-readonly" aria-labelledby="project-heading">
    <div className="project-readonly-heading">
      ...
      <div className={feedbackStyles.headingActions}>
        ...
        <ProjectCopyButton snapshot={state.snapshot} enabled={editing} busy={busy || editorSession !== null || pendingTaskDelete !== null} />
