  ...
  return <>
    ...
    {open ? <WorkspaceDialog title="프로젝트 복사" onClose={close} busy={copying || loading} restoreFocusRef={trigger}>
      ...
      {project ? <form className="project-form compact-form" noValidate onSubmit={submit}>
        ...
        <div className="form-field"><label htmlFor="detail-copy-owner">소유자</label><input id="detail-copy-owner" maxLength={100} value={ownerName} disabled={copying} onChange={(event) => setOwnerName(event.target.value)} /></div>
