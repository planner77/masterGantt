...
import { handleSetSystemChildren } from "@/server/logistics/logistics-handlers-core";

export const runtime = "nodejs";
export const dynamic = "force-dynamic";

const ROUTE = "/api/projects/[publicId]/logistics/systems/[systemId]/children";
...
export async function PUT(
  ...
  return withApiRequestLogging(
    ...
    (requestId) => {
      ...
      return handleSetSystemChildren(request, publicId, systemId, {
